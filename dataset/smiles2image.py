...
def main(smiles_path, save_dir, start_index):
    ...
    out_js = {}
    for i, (smi, qa) in enumerate(js.items()):
        idx = i + start_index
...
def parse_args():
    ...
    parser.add_argument("--smiles_path", default="data/ChEMBL_PubChem_QA_train.json", type=str, help="path to json file.")
    parser.add_argument("--save_dir", default="data/ChEMBL_PubChem_QA_image/", type=str, help="path to save output.")
